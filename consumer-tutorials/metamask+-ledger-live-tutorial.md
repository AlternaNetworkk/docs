...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on Alterna after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “Alterna network” and perform the transactions on Alterna network through your Ledger device.

Note: To learn how to add Alterna RPC follow [this link.](https://docs.alternanetwork.org/the-alterna-studio/getting-started/how-to-add-alterna-to-your-metamask)
