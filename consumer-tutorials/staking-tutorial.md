---
description: This tutorial will explain how to delegate/stake/unstake your ALTN.
---

# Staking tutorial

Note: You can only stake ALTN which is on Alterna network. Please make sure you have changed into Alterna network in Metamask while doing any transactions on staking UI. 

How to Stake Alterna:
...
You will also see the APY on staking when you enter the amount of ALTN you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
