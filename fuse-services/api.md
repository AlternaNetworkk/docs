...
## alterna-studio-backend v0.1.0

The Alterna Studio REST API for accessing the data and the services of the Alterna network in a simple way. You can use this API to query and interact with the objects of the Alterna network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Alterna network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Alterna\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Alterna network |
...
| homeBridgeAddress | `String` | Bridge address on the Alterna network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Alterna network |
...
Community is a set of contracts and services. Members of the community are users of the Alterna network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Alterna network |
| homeTokenAddress | `String` | Address of the community token on the Alterna network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Alterna network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Alterna network |
...
Entity is an account on the Alterna network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Alterna network |
...
Tokens are compatible with the ASP20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/alterna |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/alterna |
| page | `Number` | Page number for pagination |
