...
Alterna is an EVM compatible network, every tool for Ethereum can be used for the Alterna network too.
...
Since we interact with remix using Metamask, you need to change the network to Alterna network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.alternanetwork.org/the-alterna-studio/getting-started/how-to-add-alterna-to-your-metamask) to do that.

You need to have a small balance of ALTN on the Fusenet wallet you are using which will be used as Gas for the transactions.
