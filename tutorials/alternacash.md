---
description: Security practices for keeping your alterna.cash wallet secured
---

# alterna.cash wallet security guidelines

## Useful Guidelines on Keeping Your alterna.cash Wallet Secured 🔐

![](../.gitbook/assets/alterna-cash-card-image-1200x628-.png)

###  **1. Start with a Secure Foundation for Your Wallet**

Make sure your device is free of any malware and never install [**alterna.cash**](https://alterna.cash/) ****onto a rooted device. To make sure you are always using an authentic version of alterna.cash wallet, you should download the app exclusively from the links provided on our [**website**](https://alterna.cash/).
...
{% hint style="info" %}
**Backup your recovery phrase in alterna.cash wallet by navigating to 'Account' -&gt; 'Protect your wallet' -&gt; 'Back up' .**
{% endhint %}
...
To make sure only you have access to your Alterna Cash mobile app, make sure to add another layer of authentication such as Passcode or Touch/Face ID to access your funds on your Alterna Cash wallet. This prevents any bad actors accessing your wallet in case you lose your mobile device or leave it unsafe .  
****
