...
Alterna chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://scan.alternanetwork.org/address/0x31DB14a77D6eA1DfA673851A818b2e527Aaa30DE) with the following params:
...
Some other useful functions on the [voting contract](https://scan.alternanetwork.org/address/0x31DB14a77D6eA1DfA673851A818b2e527Aaa30DE) are:
